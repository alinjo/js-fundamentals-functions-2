...
function timerStatus(remainingMinutes) {
  ...
  return message = "Phil's cake is ready!"
...
function improveRecipe(cakeObject, numberOfPortions) {
  const newRecipe = {};

  for (const ingredient in cakeObject) {
    newRecipe[ingredient] = cakeObject[ingredient] * numberOfPortions;
  }
